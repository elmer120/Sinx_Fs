...
<div class="uk-container uk-container-expand uk-padding-remove"> <!-- container (padding) -->
            ...
            <h3 class="uk-text-center uk-heading-line"> <!-- titolo pagina -->
                <span>Modifica associato</span>
            </h3>

<?php echo form_open_multipart ('Anagrafica/update_associato/'.$persona->id,'class="uk-form-horizontal" onsubmit="set_enable()"');?>
...
<input type="hidden" name="fk_associato"  value="<?php echo $persona->fk_associato;?>">
    ...
    <div class="uk-form-controls">
      <input class="uk-input uk-form-width-medium" type="text" name="name" placeholder="Mario" pattern="[A-Za-z]+"  value="<?php echo $persona->name?>" required>
      <?php echo form_error('name'); ?>
    </div>
  
      <label class="uk-form-label">Cognome</label>
    <div class="uk-form-controls">
        <input class="uk-input uk-form-width-medium" class="uk-input" type="text" name="surname" pattern="[A-Za-z]+" placeholder="Last Name"  value="<?php echo $persona->surname?>">
    ...
    <div class="uk-form-controls">
      <input class="uk-input uk-form-width-medium" type="text" name="n_card" placeholder="formato libero"  value="<?php echo $persona->n_card ?>" required>
    ...
    <div class="uk-form-controls">
      ...
      <input class="uk-checkbox" name="privacy" type="checkbox" value="1" <?php echo $persona->privacy ? "checked" : "" ?> >
    </div>
  <br>
      <label class="uk-form-label">Associato attivo</label>
    <div class="uk-form-controls">
      <input class="uk-checkbox" name="active" type="hidden" value="0">
      <input class="uk-checkbox" name="active" type="checkbox" value="1" <?php echo $persona->active ? "checked" : "" ?> >
    </div>
  <br>
