...
<div class="uk-container uk-container-expand uk-padding-remove"> <!-- container (padding) -->
            ...
            <h3 class="uk-text-center uk-heading-line"> <!-- titolo pagina -->
                <span>visualizza collaboratore</span>
            </h3>

<?php echo form_open_multipart (''.$persona->id,'class="uk-form-horizontal" onsubmit="set_enable()"');?>
    ...
    <div class="uk-form-controls">
      <input class="uk-input uk-form-width-medium" type="text" name="name" pattern="[A-Za-z]+" placeholder="Mario"  value="<?php echo $persona->name?>" required disabled>
      <?php echo form_error('name'); ?>
    </div>
  
      <label class="uk-form-label">Cognome</label>
    <div class="uk-form-controls">
        <input class="uk-input uk-form-width-medium" class="uk-input" type="text" name="surname" pattern="[A-Za-z]+" placeholder="Rossi"  value="<?php echo $persona->surname?>" disabled>
    ...
    <div class="uk-form-controls">
      <input class="uk-input uk-form-width-medium" type="text" name="mansione" placeholder="Assicuratore"  value="<?php echo $persona->mansione ?>" required disabled>
      <?php echo form_error('mansione'); ?>
    </div>

    <label class="uk-form-label">Note aggiuntive</label>
    <div class="uk-form-controls">
      <textarea class="uk-textarea uk-form-width-medium" name="note" rows="2"  disabled><?php echo $persona->note ?></textarea disabled>
